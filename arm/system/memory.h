...
static inline ALWAYS_INLINE u32 get_cr(void)
{
    u32 data;
...
static inline ALWAYS_INLINE u32 get_ttbr(void)
{
    u32 data;
...
static inline ALWAYS_INLINE u32 get_dacr(void)
{
    u32 data;
...
static inline ALWAYS_INLINE void set_cr(u32 data)
{
    __asm__ volatile ( "mcr\tp15, 0, %0, c1, c0, 0" :: "r" (data) );
}

static inline ALWAYS_INLINE void set_ttbr(u32 data)
{
    __asm__ volatile ( "mcr\tp15, 0, %0, c2, c0, 0" :: "r" (data) );
}

static inline ALWAYS_INLINE void set_dacr(u32 data)
{
    __asm__ volatile ( "mcr\tp15, 0, %0, c3, c0, 0" :: "r" (data) );
}

static inline ALWAYS_INLINE u32 get_dfsr(void)
{
    u32 data;
...
static inline ALWAYS_INLINE u32 get_ifsr(void)
{
    u32 data;
...
static inline ALWAYS_INLINE u32 get_far(void)
{
    u32 data;
