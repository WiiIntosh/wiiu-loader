...
void ppc_jump_stub(u32 location, u32 entry) {
	...
	// lis r3, entry@h
	write32(location + i, 0x3C600000 | entry >> 16);
	i += sizeof(u32);
	// ori r3, r3, entry@l
	write32(location + i, 0x60630000 | (entry & 0xFFFF));
	i += sizeof(u32);
	// mtsrr0 r3
	write32(location + i, 0x7C7A03A6);
	i += sizeof(u32);
	// li r3, 0
	write32(location + i, 0x38600000);
	i += sizeof(u32);
	// mtsrr1 r3
	write32(location + i, 0x7C7B03A6);
	i += sizeof(u32);
	// rfi
	write32(location + i, 0x4C000064);
	i += sizeof(u32);
...
void ppc_wait_stub(u32 location, u32 entry) {
	...
	// li r4, 0
	write32(location + i, 0x38800000);
	i += sizeof(u32);
	// stw r4, 0(r3)
	write32(location + i, 0x90830000);
	i += sizeof(u32);
	// dcbf r0, r3
	write32(location + i, 0x7C0018AC);
	i += sizeof(u32);
	// sync
	write32(location + i, 0x7C0004AC);
	i += sizeof(u32);

	// _wait:
	// dcbi r0, r3
	write32(location + i, 0x7C001BAC);
	i += sizeof(u32);
	// sync
	write32(location + i, 0x7C0004AC);
	i += sizeof(u32);
	// lwz r4, 0(r3)
	write32(location + i, 0x80830000);
	i += sizeof(u32);
	// cmpwi cr7, r4, 0
	write32(location + i, 0x2F840000);
	i += sizeof(u32);
	// beq cr7, _wait
	write32(location + i, 0x419EFFF0);
	i += sizeof(u32);

	// mtsrr0 r4
	write32(location + i, 0x7C9A03A6);
	i += sizeof(u32);
	// li r4, 0
	write32(location + i, 0x38800000);
	i += sizeof(u32);
	// mtsrr1 r4
	write32(location + i, 0x7C9B03A6);
	i += sizeof(u32);
	// rfi
	write32(location + i, 0x4C000064);
	i += sizeof(u32);
